...
\HRule \\[0.5cm]
{\huge \bfseries Система полнотекстового поиска}
...
\begin{flushright}
  \begin{tabular}{rrlc}
    Исполнитель:  &    студент ИУ7-61 & Фамилия~И.\,О.  & \underline{\hspace{3cm}} \\[1cm]
    Руководитель: & преподаватель ИУ7 & Фамилия~И.\,О. & \underline{\hspace{3cm}} \\[1cm]
  \end{tabular}
\end{flushright}
